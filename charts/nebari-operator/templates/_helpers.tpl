...
*/}}
{{- define "nebari-operator.fullname" -}}
...
*/}}
{{- define "nebari-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "nebari-operator.resourceName" -}}
{{- $fullname := include "nebari-operator.fullname" .context }}
{{- $suffix := .suffix }}
